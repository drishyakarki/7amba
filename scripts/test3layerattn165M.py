...
trainer.save_model('samba-165M-model-3layerattn')
tokenizer.save_pretrained('samba-165M-model-3layerattn')

tokenizer = AutoTokenizer.from_pretrained('samba-165M-model-3layerattn')
model = SambaForCausalLM.from_pretrained('samba-165M-model-3layerattn')
