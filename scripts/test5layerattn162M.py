...
trainer.save_model('samba-162M-model-5layerattn')
tokenizer.save_pretrained('samba-162M-model-5layerattn')

tokenizer = AutoTokenizer.from_pretrained('samba-162M-model-5layerattn')
model = SambaForCausalLM.from_pretrained('samba-162M-model-5layerattn')
