...
trainer.save_model('samba-348M-model-5layerattn')
tokenizer.save_pretrained('samba-348M-model-5layerattn')

tokenizer = AutoTokenizer.from_pretrained('samba-348M-model-5layerattn')
model = SambaForCausalLM.from_pretrained('samba-348M-model-5layerattn')
