...
trainer.save_model('samba-162M-model-7layerattn')
tokenizer.save_pretrained('samba-162M-model-7layerattn')

tokenizer = AutoTokenizer.from_pretrained('samba-162M-model-7layerattn')
model = SambaForCausalLM.from_pretrained('samba-162M-model-7layerattn')
