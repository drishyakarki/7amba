...
trainer.save_model('samba-350M-model-7layerattn')
tokenizer.save_pretrained('samba-350M-model-7layerattn')

tokenizer = AutoTokenizer.from_pretrained('samba-350M-model-7layerattn')
model = SambaForCausalLM.from_pretrained('samba-350M-model-7layerattn')
