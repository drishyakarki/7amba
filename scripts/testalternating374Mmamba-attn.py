...
trainer.save_model('samba-374M-model-alternating')
tokenizer.save_pretrained('samba-374M-model-alternating')

tokenizer = AutoTokenizer.from_pretrained('samba-374M-model-alternating')
model = SambaForCausalLM.from_pretrained('samba-374M-model-alternating')
