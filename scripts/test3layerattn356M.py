...
trainer.save_model('samba-350M-model-3layerattn')
tokenizer.save_pretrained('samba-350M-model-3layerattn')

tokenizer = AutoTokenizer.from_pretrained('samba-356M-model-3layerattn')
model = SambaForCausalLM.from_pretrained('samba-356M-model-3layerattn')
